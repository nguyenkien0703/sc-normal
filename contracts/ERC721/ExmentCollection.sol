 ...
 * {ERC721Enumerable}.
 */
contract ExmentCollection is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // called once by the market at time of deployment
    /**
    ...
    /**
     * @dev @dev Mints a tokenIdNext and transfers it to `to`.
     */
    function mint(address to) external onlyMarket returns (uint256){
        _mint(to, ++_tokenIds);
        return _tokenIds;
    }
     ...
     *
     */
    function setBaseURI(string memory uri_) external onlySeller {
        _base_uri = uri_;
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require(_balances[to] == 0, "ExmentCollection: buyer already bought");
