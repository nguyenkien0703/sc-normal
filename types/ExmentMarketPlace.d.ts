...
interface ExmentMarketPlaceInterface extends ethers.utils.Interface {
  functions: {
...
export class ExmentMarketPlace extends Contract {
  ...
  interface: ExmentMarketPlaceInterface;
  ...
  collections(index: BigNumberish, overrides?: CallOverrides): Promise<string>;
