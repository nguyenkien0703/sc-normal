const shell = require('shelljs');// thực hiện các tác vụ 
const ohm = require('ohm-js');// xay dung và kiem tra, phan tích cu phap cua ngon ngu 
...
for(const buildArtifact of shell.ls('artifacts/contracts/**/*.json')) {
...
shell.ShellString(generationInterfaceOutput).to('artifacts/abi-interfaces.ts');

console.log(`Generated artifacts/abi-interfaces.ts from ${contracts.size} contracts`);
